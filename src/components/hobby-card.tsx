...
import { HobbyInfo } from "@/lib/types"
import { motion, useScroll, useTransform } from "framer-motion"
import { useRef } from "react"
import { li } from "framer-motion/client";

type HobbyProps = HobbyInfo;
...
export default function Hobby({
    ...
    return (
        ...
        className="group mb-3 sm:mb-8 last:mb-0">
            <section className="bg-white max-w-[42rem] botder border-black
            5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem]
            ...
            dark:bg-white/10 dark:hover:bg-white/20">
                ...
                sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
                    ...
                    <ul className="flex flex-warp mt-4 gap-2 sm:mt-auto">
                        {
                           tags.map((tag, index) =>(
                ...
                width={400}
                height={100}
                className="aboslute hidden sm:block top-8 -right-40
